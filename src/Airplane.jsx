...
import { Matrix4, Quaternion, Vector3, MeshBasicMaterial } from 'three';
...
export function Airplane(props) {
  const { nodes, materials, scene } = useGLTF('assets/models/cube.glb');
  const groupRef = useRef();

  // Aplicar material wireframe cyan al cubo
  useEffect(() => {
...
useGLTF.preload('assets/models/cube.glb');
